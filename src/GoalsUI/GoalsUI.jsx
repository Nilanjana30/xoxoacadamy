    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden text-white bg-purple-900">
      ...
      <div className="absolute top-0 left-0 w-2/3 sm:w-1/4 md:w-2/6 2xl:w-2/6 lg:w-2/6">
        <img
          ...
          2xl:rotate-0 lg:rotate-0 md:rotate-[270deg] md:mt-[-110px] rotate-[260deg]
          2xl:mt-[-100px] lg:mt-[-100px] mt-[-120px]"
        />
      </div>
      ...
      {/* Content Section */}
      <div className="flex flex-col items-center max-w-6xl gap-12 px-4 text-center 2xl:gap-40 lg:gap-40 md:flex-col md:px-6 md:text-left md:gap-2 2xl:flex-row lg:flex-row mb-[-70px]">
